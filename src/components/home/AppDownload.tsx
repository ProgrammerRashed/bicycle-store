    ...
    <section className="py-12 bg-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          ...
          <div className="flex max-w-md mx-auto mb-8 bg-white">
            <Input type="email" placeholder="Enter your email address here" className="rounded-r-none" />
            <Button className="rounded-l-none bg-primary">Subscribe</Button>
          </div>
        </div>
      </div>
    </section>
